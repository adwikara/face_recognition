...
Dadang_image = face_recognition.load_image_file("images/Dadang.jpg")
Dadang_face_encoding = face_recognition.face_encodings(Dadang_image)[0]

# Load a third sample picture and learn how to recognize it.
Riri_image = face_recognition.load_image_file("images/Riri.jpg")
Riri_face_encoding = face_recognition.face_encodings(Riri_image)[0]
